...
cur.execute("INSERT INTO persona VALUES ('1','1', 'Carlos Eduardo Currieco Pavié','Chileno','Doctor',NULL)")
cur.execute("INSERT INTO popularidad VALUES ('1','1', 'Carlos Eduardo Currieco Pavié',NULL,NULL)")
conn.commit() 
conn.close()